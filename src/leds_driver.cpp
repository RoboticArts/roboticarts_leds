...
int main (int argc, char** argv){
	...
	led_properties.command = TURN_RIGHT;
	led_properties.init_led = 0;
	led_properties.end_led = 6;
	led_properties.color_R = 0;
	led_properties.color_G = 0;
	led_properties.color_B = 150;
	led_properties.data_time = 20;
